  ...
  public async atualizar(modal: TemplateRef<any>, requisicao?: Requisicao) {
    ...
    try {
      ...
      if (this.form.dirty && this.form.valid) {
        ...
        this.toastrService.success(`A movimentação foi salva com sucesso!`, "Cadastro de Requisições");
      }
      else
      ...
      if (error != "fechar" && error != "0" && error != "1")
        this.toastrService.error("Houve um erro ao salvar a movimentação. Tente novamente.", "Cadastro de Requisições")
    }
